...
//
    ...
    private void openOtherInfo() {
        startActivity(new Intent(MainActivity1.this, OtherInfo.class));
    }
...
//    }
    ...
    {
        startActivity(new Intent(MainActivity1.this, MetroMap.class));
    }
    private void openBuyTicket()
    {
        startActivity(new Intent(MainActivity1.this,BuyTickets.class));
    }
    private void openHolidayList()
    {
        startActivity(new Intent(MainActivity1.this, HolidayList.class));
    }
    public void openFareActivity(@NonNull String source, String dest) {
        ...
        if(source.equals("Select Source") && dest.equals("Select Destination"))
            Toast.makeText(MainActivity1.this, "Please select Source & Destination", Toast.LENGTH_SHORT).show();
        else if( source.equals("Select Source") )
            Toast.makeText(MainActivity1.this, "Please select Source", Toast.LENGTH_SHORT).show();
        else if( dest.equals("Select Destination") )
            Toast.makeText(MainActivity1.this, "Please select Destination", Toast.LENGTH_SHORT).show();
        else if(source.equals(dest))
            Toast.makeText(MainActivity1.this, "Source & Destination should not be same", Toast.LENGTH_SHORT).show();
        else {
...
//        actvDestination = dest;
    ...
    {
        startActivity(new Intent(MainActivity1.this, FareCalculator.class));
    }
    public void minInterchange(String start,String dest)
    {
        int f = new FareCalculator().fare(start,dest);
        Intent intent = new Intent(MainActivity1.this, MinInterChange.class);
...
//    }
                ...
                if (e instanceof ApiException ) {
                    ...
                    if (statusCode == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                        try {
                            ...
                            resolvable.startResolutionForResult(MainActivity1.this, REQUEST_CHECK_SETTINGS);
    ...
    private void startLocationUpdates() {
        ...
        Intent intent = new Intent(MainActivity1.this, NearestMetro.class);
        startActivity(intent);
    }
//    private void openSourceList() {
//        Intent intent = new Intent(MainActivity1.this, StationList.class);
//        startActivity(intent);
//        finish();
//         source = getIntent().getStringExtra("selectedItem");
//         sourceText.setText(source);
//
//    }
...
//        startActivity(intent);
//        finish();
//        dest = getIntent().getStringExtra("selectedItem");
//        destText.setText(dest);
//    }
private void openSourceList() {
    Intent intent = new Intent(MainActivity1.this, StationList.class);
