...
public class FareCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v1 = (TextView) findViewById(R.id.fareText);

        actvSource = (AutoCompleteTextView) findViewById(R.id.actv1_calc);
        actvDestination = (AutoCompleteTextView) findViewById(R.id.actv2_calc);
        Click = (Button) findViewById(R.id.btn_calc);
        r = (Button) findViewById(R.id.reset_calc);
    ...
    public int fare(String start,String stop) {
        ...
        int sIndex=-1;
        int eIndex=-1;
//        String start = actvSource.getText().toString().trim();
//        String stop = actvDestination.getText().toString().trim();
